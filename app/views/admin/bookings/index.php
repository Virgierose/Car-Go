...
<div class="tab-bar">
    ...
    foreach ($statuses as $s):
        $url = $s === 'All' ? '/admin/bookings' : '/admin/bookings?status=' . urlencode($s);
    ?>
...
<div class="filter-bar">
    <form method="GET" action="/admin/bookings" class="filter-form">
        ...
        <div class="filter-group">
            <input type="date" name="date_from" class="filter-input date-input" value="<?= htmlspecialchars($_GET['date_from'] ?? '') ?>" placeholder="From">
        </div>
        <div class="filter-group">
            <input type="date" name="date_to" class="filter-input date-input" value="<?= htmlspecialchars($_GET['date_to'] ?? '') ?>" placeholder="To">
        </div>
        <button type="submit" class="btn btn-outline">Filter</button>
        <a href="/admin/bookings" class="btn btn-ghost">Reset</a>
    </form>
</div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-btns">
                        <a href="/admin/bookings/<?= $b['booking_id'] ?>" class="btn-action btn-view" title="View"><i class="fas fa-eye"></i></a>
                        <!-- Quick status update -->
                        <div class="status-dropdown-wrap">
                            ...
                            <div class="status-dropdown" id="dd-<?= $b['booking_id'] ?>">
                                ...
                                <form method="POST" action="/admin/bookings/<?= $b['booking_id'] ?>/status">
